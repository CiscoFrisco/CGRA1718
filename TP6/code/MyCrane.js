 ...
 */
 ...
 {
     constructor(scene, initAngle = Math.PI/6)
     {
         super(scene);
     ...
     this.scene.pushMatrix();
        ...
        this.scene.pushMatrix();
                this.scene.translate(0.1,- Math.sin(this.angleX + this.initAngle)*5.4 -2,Math.cos(this.angleX + this.initAngle)*5.4);
                this.scene.rotate(-Math.PI/2, 1, 0, 0);
